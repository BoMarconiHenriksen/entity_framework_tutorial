namespace ConsoleApp1.Migrations
{
    ...
    public partial class initialModel : DbMigration
    {
        ...
        {
            // Laver Authors tabellen.
            CreateTable(
                "dbo.Authors",
                c => new
                    {
                        // Tilføjer de her kolonner.
            ...
            CreateTable(
                ...
                // Index så vi kan få alle courses fra en author.
                .Index(t => t.Author_Id);
            ...
            // Dette er intermedier tabellen i en mange til mange relation.
            CreateTable(
                "dbo.TagCourses",
                c => new
                    {
